...
class Tree {
  ...
  constructor(element, options, classNames, selectors, events) {
    ...
    // Set options here
    this.options = __WEBPACK_IMPORTED_MODULE_0__Utilities__["a" /* default */].grabOptions(this.Default, options, this.element);
  ...
  toggle(link, event) {
    ...
    const treeviewMenu = __WEBPACK_IMPORTED_MODULE_0__Utilities__["a" /* default */].findChildren('UL', this.ClassName.treeviewMenu, parentLi);
  ...
  expand(tree, parentLi) {
    ...
    const openMenus = __WEBPACK_IMPORTED_MODULE_0__Utilities__["a" /* default */].findChildren('LI', this.ClassName.open, parentLi.parentNode);

    // For each currently opened menu (which should be just 1) we should close
    if (this.options.accordion) {
      Array.prototype.forEach.call(openMenus, (menu) => {
        const openTree = __WEBPACK_IMPORTED_MODULE_0__Utilities__["a" /* default */].findChildren('UL', this.ClassName.treeviewMenu, menu);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_BoxRefresh__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_BoxWidget__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_ControlSidebar__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_DirectChat__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_Layout__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_PushMenu__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_TodoList__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__src_Tree__ = __webpack_require__(1);
 ...
 */
const binder = () => {
  __WEBPACK_IMPORTED_MODULE_0__src_BoxRefresh__["a" /* default */].bind();
  __WEBPACK_IMPORTED_MODULE_1__src_BoxWidget__["a" /* default */].bind();
  __WEBPACK_IMPORTED_MODULE_2__src_ControlSidebar__["a" /* default */].bind();
  __WEBPACK_IMPORTED_MODULE_3__src_DirectChat__["a" /* default */].bind();
  __WEBPACK_IMPORTED_MODULE_4__src_Layout__["a" /* default */].bind();
  __WEBPACK_IMPORTED_MODULE_5__src_PushMenu__["a" /* default */].bind();
  __WEBPACK_IMPORTED_MODULE_6__src_TodoList__["a" /* default */].bind();
  __WEBPACK_IMPORTED_MODULE_7__src_Tree__["a" /* default */].bind();
}
...
/* harmony default export */ __webpack_exports__["a"] = (BoxRefresh);
...
/* harmony default export */ __webpack_exports__["a"] = (BoxWidget);
...
/* harmony default export */ __webpack_exports__["a"] = (DirectChat);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Utilities__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Tree__ = __webpack_require__(1);
...
class Layout {
  ...
  activate() {
    ...
    if (sidebarMenu) {
      sidebarMenu.addEventListener(__WEBPACK_IMPORTED_MODULE_1__Tree__["a" /* default */].Event.expanded, this.fixLayout.bind(this));
      sidebarMenu.addEventListener(__WEBPACK_IMPORTED_MODULE_1__Tree__["a" /* default */].Event.collapsed, this.fixLayout.bind(this));
    }
  }
...
/* harmony default export */ __webpack_exports__["a"] = (PushMenu);
