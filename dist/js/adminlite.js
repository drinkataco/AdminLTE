...
const Layout = (() => {
  ...
  const activate = () => {
    ...
    document.querySelector('.sidebar-menu').addEventListener('tree_expanded', fixLayout);
    document.querySelector('.sidebar-menu').addEventListener('tree_collapsed', fixLayout);
  };
